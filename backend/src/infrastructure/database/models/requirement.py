...
from src.domain.requirement.rules import MAX_REQUIREMENT_TITLE_LENGTH
...
class RequirementModel(Base):
    ...
    title: Mapped[str] = mapped_column(String(MAX_REQUIREMENT_TITLE_LENGTH), nullable=False)
