...
from src.infrastructure.storage.parsers.excel_source_parser import parse_excel
from src.infrastructure.storage.parsers.markdown_source_parser import parse_markdown
from src.infrastructure.storage.parsers.sql.sql_source_parser import parse_sql
from src.infrastructure.storage.parsers.tabular_source_models import ParsedSource
