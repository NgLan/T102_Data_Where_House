...
- Step 3 (RAG): Retrieve Kimball rules & Anti-pattern context from Vector DB.
...
Always return a structured JSON response containing `model_metadata`, `tables` (with Fact/Dim, Grain, PK/FK, DDL SQL), `mermaid_erd`, `sandbox_execution_plan`, and `anti_pattern_warnings`.
"""
