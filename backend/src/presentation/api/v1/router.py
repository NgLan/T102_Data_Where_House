...
from src.presentation.api.v1.data_model_changes import router as data_model_changes_router
from src.presentation.api.v1.data_model_generation import router as data_model_generation_router
...
router.include_router(data_model_changes_router)
