...
export interface ChangeProposalDetailDto extends ChangeProposalSummaryDto {
  ...
  is_outdated: boolean;
  /**
   * Lời giải thích của AI Agent về thay đổi vừa đề xuất.
   * Chỉ có nội dung ngay sau khi tạo đề xuất bằng AI; khi tải lại đề xuất đã lưu thì rỗng
   * vì phần diễn giải không được lưu xuống CSDL.
   */
  summary: string;
}
